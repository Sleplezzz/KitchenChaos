...
mentionsOnly.subscribe(() =>
  console.log(mentionsOnly.getSnapshot().messages.length),
);
```

## Read state

Every channel tracks a **watermark** — how far _this device_ has read, independent of
